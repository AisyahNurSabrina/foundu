    ...
    <div class="col-lg-6 fade-in-up">
        <div class="card card-glass border-0" style="border-radius: var(--radius-lg);">
            <div class="card-body p-4 p-md-5">
                <h3 class="page-title mb-4">Tambah Kategori</h3>
                <form method="POST" action="{{ route('categories.store') }}">
                    @csrf
                    <div class="mb-3">
                        <label for="name" class="form-label">Nama Kategori <span class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" required placeholder="Masukkan nama kategori">
